...
namespace Ryujinx.Graphics.Nvdec.Vp9
{
    internal static class DecodeFrame
    {
            ...
            bool multithreaded = true)
        {
            ...
            int baseThreads = Math.Max(1, processorCount / 2);
            int scaledThreads = (int)Math.Ceiling(baseThreads * 1.5f);
            int threadCount = multithreaded ? Math.Max(2, scaledThreads) : 0;
