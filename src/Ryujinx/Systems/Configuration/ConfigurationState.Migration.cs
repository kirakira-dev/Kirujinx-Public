...
namespace Ryujinx.Ava.Systems.Configuration
{
    public partial class ConfigurationState
    {
        public void Load(ConfigurationFileFormat cff, string configurationFilePath, string titleId = "")
        {
            ...
            Graphics.LockTo30Fps.Value = cff.LockTo30Fps;
            Graphics.EnablePerformanceMode.Value = cff.EnablePerformanceMode;
            ...
            System.EnableFullPtc.Value = cff.EnableFullPtc;
            System.EnableOnDemandUsage.Value = cff.EnableOnDemandUsage;
            System.PrioritizeSocketConnections.Value = cff.PrioritizeSocketConnections;
            ...
            UI.AccentColor.Value = shouldLoadFromFile && !string.IsNullOrEmpty(cff.AccentColor) ? cff.AccentColor : UI.AccentColor.Value;
            UI.GameListBackgroundOpacity.Value = shouldLoadFromFile && cff.GameListBackgroundOpacity > 0 ? cff.GameListBackgroundOpacity : UI.GameListBackgroundOpacity.Value;
            UI.EnableCustomAccentColor.Value = shouldLoadFromFile ? cff.EnableCustomAccentColor : UI.EnableCustomAccentColor.Value;
