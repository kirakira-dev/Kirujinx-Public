...
namespace Ryujinx.Ava.Systems.Configuration
{
    public partial class ConfigurationState
    {
        ...
        public class UISection
        {
            ...
            /// <summary>
            /// Accent color for the UI theme (hex color code)
            /// </summary>
            public ReactiveObject<string> AccentColor { get; private set; }

            /// <summary>
            /// Game list background opacity (0.0 - 1.0)
            /// </summary>
            public ReactiveObject<float> GameListBackgroundOpacity { get; private set; }

            /// <summary>
            /// Enable custom accent color
            /// </summary>
            public ReactiveObject<bool> EnableCustomAccentColor { get; private set; }
            ...
            public UISection()
            {
                ...
                AccentColor = new ReactiveObject<string>();
                GameListBackgroundOpacity = new ReactiveObject<float>();
                EnableCustomAccentColor = new ReactiveObject<bool>();
        ...
        public class SystemSection
        {
            ...
            /// <summary>
            /// Enables or disables full translation cache (PPFTC) - translates ALL code on first startup
            /// </summary>
            public ReactiveObject<bool> EnableFullPtc { get; private set; }
            ...
            /// <summary>
            /// Enables On-Demand Usage mode - allows Ryujinx to use maximum system resources
            /// </summary>
            public ReactiveObject<bool> EnableOnDemandUsage { get; private set; }

            /// <summary>
            /// Prioritizes socket connections over shader loading for better online gameplay
            /// </summary>
            public ReactiveObject<bool> PrioritizeSocketConnections { get; private set; }
            ...
            public SystemSection()
            {
                ...
                EnableFullPtc = new ReactiveObject<bool>();
                EnableFullPtc.LogChangesToValue(nameof(EnableFullPtc));
                EnableFullPtc.Event += (_, evnt)
                    => ARMeilleure.Translation.PTC.FullTranslationCache.EnableFullTranslation = evnt.NewValue;
                ...
                EnableOnDemandUsage = new ReactiveObject<bool>();
                EnableOnDemandUsage.LogChangesToValue(nameof(EnableOnDemandUsage));
                EnableOnDemandUsage.Event += (_, evnt)
                    => Ryujinx.Common.Utilities.OnDemandResourceManager.EnableOnDemandUsage = evnt.NewValue;
                PrioritizeSocketConnections = new ReactiveObject<bool>();
                PrioritizeSocketConnections.LogChangesToValue(nameof(PrioritizeSocketConnections));
                PrioritizeSocketConnections.Event += (_, evnt)
                    => Ryujinx.Common.Utilities.SocketPriorityManager.PrioritizeSocketConnections = evnt.NewValue;
            }
        }
        ...
        public class GraphicsSection
        {
            ...
            /// <summary>
            /// Locks framerate to 30fps and prioritizes loading shaders/scenes during extra frame budget
            /// </summary>
            public ReactiveObject<bool> LockTo30Fps { get; private set; }

            /// <summary>
            /// Enables Performance Mode with dynamic resolution, batching, and frame skip for higher FPS
            /// </summary>
            public ReactiveObject<bool> EnablePerformanceMode { get; private set; }
            ...
            public GraphicsSection()
            {
                ...
                LockTo30Fps = new ReactiveObject<bool>();
                LockTo30Fps.LogChangesToValue(nameof(LockTo30Fps));
                LockTo30Fps.Event += (_, evnt)
                    => Ryujinx.Common.Utilities.FpsLockManager.LockTo30Fps = evnt.NewValue;
                EnablePerformanceMode = new ReactiveObject<bool>();
                EnablePerformanceMode.LogChangesToValue(nameof(EnablePerformanceMode));
                EnablePerformanceMode.Event += (_, evnt)
                    => Ryujinx.Common.Utilities.PerformanceMode.Enabled = evnt.NewValue;
