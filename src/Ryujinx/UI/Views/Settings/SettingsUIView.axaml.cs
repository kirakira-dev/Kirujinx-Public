...
namespace Ryujinx.Ava.UI.Views.Settings
{
    public partial class SettingsUiView : RyujinxControl<SettingsViewModel>
    {
        ...
        private void KiraKiraSecretButton_OnClick(object sender, RoutedEventArgs e)
        {
            Window settingsWindow = TopLevel.GetTopLevel(this) as Window;
            settingsWindow?.Close();

            KiraKiraPrankWindow prankWindow = new KiraKiraPrankWindow();
            prankWindow.Show();
        }
    }
}
