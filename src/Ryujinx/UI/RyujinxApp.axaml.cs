...
namespace Ryujinx.Ava
{
    public class RyujinxApp : Application
    {
        ...
        public static readonly string FullAppName = string.Intern(ReleaseInformation.IsCanaryBuild ? "Kirujinx Canary" : "Kirujinx");
        ...
        public override void Initialize()
        {
            ...
            if (OperatingSystem.IsMacOS())
            {
                ...
                Process.Start("/usr/bin/defaults", "write org.kirujinx.Kirujinx ApplePressAndHoldEnabled -bool false");
            }
        }
