...
namespace Ryujinx.Graphics.Gpu
{
    ...
    public sealed class GpuContext : IDisposable
    {
        ...
        /// <summary>
        /// Scene transition manager for optimizing loading and transitions.
        /// </summary>
        public SceneTransitionManager SceneTransition { get; }

        /// <summary>
        /// Frame pacing optimizer for smooth frame delivery.
        /// </summary>
        public Engine.FramePacingOptimizer FramePacing { get; }

        /// <summary>
        /// Async shader compiler for background shader compilation.
        /// </summary>
        public Shader.AsyncShaderCompiler AsyncShaderCompiler { get; }

        /// <summary>
        /// Work scheduler for deferring heavy operations during transitions.
        /// </summary>
        public TransitionWorkScheduler WorkScheduler { get; }

        /// <summary>
        /// Dynamic resolution scaler for adapting resolution to maintain FPS.
        /// </summary>
        public DynamicResolutionScaler DynamicResolution { get; }

        /// <summary>
        /// GPU command batcher for reducing draw call overhead.
        /// </summary>
        public GpuCommandBatcher CommandBatcher { get; }

        /// <summary>
        /// Frame skip manager for dropping frames when performance is low.
        /// </summary>
        public FrameSkipManager FrameSkip { get; }
        ...
        public GpuContext(IRenderer renderer, DirtyHacks hacks)
        {
            ...
            SceneTransition = new SceneTransitionManager();
            FramePacing = new Engine.FramePacingOptimizer();
            AsyncShaderCompiler = new Shader.AsyncShaderCompiler(renderer);
            WorkScheduler = new TransitionWorkScheduler(this);
            DynamicResolution = new DynamicResolutionScaler(this);
            CommandBatcher = new GpuCommandBatcher(this);
            FrameSkip = new FrameSkipManager(this);
