...
namespace Ryujinx.Graphics.Gpu.Shader
{
    ...
    class ShaderCache : IDisposable
    {
        ...
        private readonly ShaderCachePrefetcher _prefetcher;
        private readonly DiskCache.ShaderCompilationBatcher _compilationBatcher;
        ...
        /// <summary>
        /// Gets the shader cache prefetcher.
        /// </summary>
        public ShaderCachePrefetcher Prefetcher => _prefetcher;

        /// <summary>
        /// Gets the shader compilation batcher.
        /// </summary>
        public DiskCache.ShaderCompilationBatcher CompilationBatcher => _compilationBatcher;
        ...
        public ShaderCache(GpuContext context)
        {
            ...
            if (_diskCacheHostStorage.CacheEnabled)
            {
                ...
                _prefetcher = new ShaderCachePrefetcher(diskCacheTitleId);
                _compilationBatcher = new DiskCache.ShaderCompilationBatcher(context.Renderer);
            }
        }
            ...
            ulong gpuVa)
        {
            ...
            _context.SceneTransition.RecordShaderCompilation();
